...
/**
 * Purpose: To perform addition, subtraction,
...
public class CalculationsV6
{
    public static void main(String[ ] args)
    {
        ...
        System.out.println(dNum5 + " - " + dNum3 + " / " + dNum4 + " = " + (dNum5 - dNum3 / dNum4));
        System.out.println(dNum6 + " % " + dNum5 + " + " + dNum4 + " / " + dNum3 + " = " + (dNum6 % dNum5 + dNum4 / dNum3));
        System.out.println();
        //System.out.println();
